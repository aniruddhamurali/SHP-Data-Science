...
url <- "https://github.com/lydiahsu/Intro-Data-Science-Fall-2017/raw/gh-pages/example/NYPD_Complaint_Data_Historic.csv"
crime <- read.csv(url)
...
ggplot(data = daily_crime) +
  ...
  geom_smooth(method = "lm", 
              formula = y ~ sin(2*pi*x/period) + cos(2*pi*x/period))
...
#polygons
shape <- rgdal::readOGR("/Users/aniruddha/Downloads/area2/", "area2_poly")
shape
plot(x = shape)
